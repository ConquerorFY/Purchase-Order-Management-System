...
class Purchase_Records {
	...
	public:
		...
		// Getters
		int get_order_id(void) { return order_id; }
		int get_client_id(void) { return client_id; }
		string get_client_name(void) { return client_name; }
		string get_item_ids(void) { return item_ids; }
		double get_price(void) { return price; }
		string get_date(void) { return date; }
		string get_time(void) { return time; }
		string get_type(void) { return type; }
		string get_status(void) { return status; }

		// Setters
		void set_order_id(int id) { order_id = id; }
		void set_client_id(int id) { client_id = id; }
		void set_client_name(string name) { client_name = name; }
		void set_item_ids(string ids) { item_ids = ids; }
